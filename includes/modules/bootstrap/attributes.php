    ...
    */
    ...
    switch (true) {
        ...
        case ($products_options_type == PRODUCTS_OPTIONS_TYPE_TEXT):
            $options_name[] = '<label class="form-label attribsInput" for="' . $inputFieldId . '">' . ($show_attributes_qty_prices_icon ? ATTRIBUTES_QTY_PRICE_SYMBOL : '') . $products_options_name . '</label>';
        ...
        case ($products_options_type == PRODUCTS_OPTIONS_TYPE_CHECKBOX):
            ...
            $tmp_checkbox = '<div class="form-check" role="checkbox" aria-label="' . $products_options_name . '">';
        ...
        case ($products_options_type == PRODUCTS_OPTIONS_TYPE_RADIO):
            ...
            $tmp_radio = '<div class="form-check" role="radiogroup" aria-label="' . $products_options_name . '">';
            $options_menu[] = $tmp_radio . "\n";
            break;

        // file upload
        case ($products_options_type == PRODUCTS_OPTIONS_TYPE_FILE):
            $options_name[] = '<label class="form-label attribsUploads" for="' . $inputFieldId . '">' . ($show_attributes_qty_prices_icon ? ATTRIBUTES_QTY_PRICE_SYMBOL : '') . $products_options_name . '</label>';
            $options_html_id[] = 'upl-attrib-' . $products_options_id;
            $tmp_html = '<div class="mb-3">';
            $tmp_html .= '<input class="form-control" type="file" name="id[' . TEXT_PREFIX . $products_options_id . ']" id="' . $inputFieldId . '" ' . $data_properties . '>';
            $tmp_html .= '</div>';
            $options_menu[] = $tmp_html . "\n";
            break;
        ...
        case ($products_options->RecordCount() == 1):
            if ($show_attributes_qty_prices_icon) {
                $options_name[] = '<label class="form-label switchedLabel ONE" for="' . $inputFieldId . '">' . ATTRIBUTES_QTY_PRICE_SYMBOL . $products_options_name . '</label>';
            } else {
                $options_name[] = $products_options_name;
            }
            $options_html_id[] = 'drprad-attrib-' . $products_options_id;
            $options_menu[] = '<div class="form-check">' . zen_draw_radio_field('id[' . $products_options_id . ']', $products_options_value_id, true, 'id="' . $inputFieldId . '" ' . $data_properties . $field_disabled) . '<label class="form-check-label attribsRadioButton" for="' . $inputFieldId . '">' . $products_options_details . '</label></div>' . "\n";
            break;
        ...
        case ($products_options_type == PRODUCTS_OPTIONS_TYPE_SELECT):
            ...
            if ($show_attributes_qty_prices_icon) {
                ...
                $options_name[] = '<label class="form-label attribsSelect" for="' . $inputFieldId . '">' . $products_options_name . '</label>';
            }
            $options_html_id[] = 'drp-attrib-' . $products_options_id;
            $options_menu[] = zen_draw_pull_down_menu('id[' . $products_options_id . ']', $products_options_array, $selected_attribute, 'id="' . $inputFieldId . '" class="form-select" aria-label="' . $products_options_name . '" ' . $data_properties . $field_disabled) . "\n";
            break;
    ...
    if ($tmp_attributes_image_row > $products_options_names->fields['products_options_images_per_row']) {
        $tmp_attributes_image .= '</div><div class="row g-3">' . "\n";
        $tmp_attributes_image_row = 1;
    }
