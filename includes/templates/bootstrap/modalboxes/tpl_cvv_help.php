...
?>
<!-- Modal -->
<div id="cvvHelpModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="cvvHelpModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="cvvHelpModalLabel" class="modal-title"><?php echo HEADING_CVV; ?></h5>
