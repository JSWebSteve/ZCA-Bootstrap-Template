...
<div id="customersAuthorizationDefault" class="centerColumn">
    ...
    <div id="customersAuthorizationDefault-image">
        <?php echo zen_image(DIR_WS_TEMPLATE_IMAGES . OTHER_IMAGE_CUSTOMERS_AUTHORIZATION, OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT, '', '', 'class="img-fluid"'); ?>
    </div>
    ...
    <div id="customersAuthorizationDefault-btn-toolbar" class="d-flex justify-content-start mt-3" role="toolbar">
        <?php echo zca_button_link(zen_href_link(CUSTOMERS_AUTHORIZATION_FILENAME), BUTTON_CONTINUE_ALT, 'button_continue btn btn-primary'); ?>
    </div>
</div>
