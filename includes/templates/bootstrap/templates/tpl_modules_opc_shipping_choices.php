...
?>
    <h4 id="shipping-method-heading" class="card-header"><?= TABLE_HEADING_SHIPPING_METHOD ?></h4>
    <div class="card-body" aria-labelledby="shipping-method-heading">
<?php
...
?>
        <div id="checkoutShippingContentChoose" class="alert alert-info" role="alert">
...
?>
        <div id="freeShip" class="alert alert-success" role="alert">
            <?= FREE_SHIPPING_TITLE ?>
        </div>
...
?>
        <h3 id="checkoutShippingHeadingMethod"><?= TITLE_NO_SHIPPING_AVAILABLE ?></h3>
<?php
...
?>
        <div id="cartLocalText" class="alert alert-warning" role="alert">
...
?>
        <div id="checkoutShippingContentChoose" class="alert alert-danger" role="alert">
