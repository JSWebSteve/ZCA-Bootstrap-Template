        ...
        <div class="col-md-6">
            <div id="billingAddress-card" class="card mb-3">
                ...
                <div id="billingAddress-card-body" class="card-body p-3">
                    <div class="row">
                        <div id="billToAddress-card" class="col-md-6">
...
?>
                        ...
                        <div id="paymentMethod-card" class="col-md-6">
...
?>
            <div id="deliveryAddress-card" class="card mb-3">
                ...
                <div id="deliveryAddress-card-body" class="card-body p-3">
                    <div class="row">
                        <div id="shipToAddress-card" class="col-md-6">
...
?>
                        <div id="shippingMethod-card" class="col-md-6">
...
?>
    <div id="checkoutConfirmationDefault-btn-toolbar" class="d-flex justify-content-between align-items-center" role="toolbar">
        <div><strong><?php echo $title_continue_checkout; ?></strong><br><?php echo TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></div>
        <?php echo zen_image_submit(BUTTON_IMAGE_CONFIRM_ORDER, BUTTON_CONFIRM_ORDER_ALT, 'name="btn_submit" id="btn_submit" class="btn btn-primary"') ;?>
    </div>
    <?php echo '</form>'; ?>
</div>
