...
<!--bof email notifications card links-->
        <div class="col">
            <div id="emailNotifications-card" class="card h-100">
...
<!--eof email notifications card links-->
<?php 
...
<!--bof previous orders card -->
    <div id="previousOrders-card" class="card mb-3">
        ...
        <div id="previousOrders-card-body" class="card-body p-3">
            <div id="previousOrders-helpLink" class="helpLink d-flex justify-content-end p-3">
