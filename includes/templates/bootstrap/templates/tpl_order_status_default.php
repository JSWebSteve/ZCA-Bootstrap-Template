...
//
// Last updated: OPC v2.5.4/BOOTSTRAP v5.0.0
//
// -----
...
?>
<div id="orderStatus" class="centerColumn">
...
?>
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="text-end"><?= HEADING_ORDER_DATE . ' ' . zen_date_long($order->info['date_purchased']) ?></div>
<?php 
...
?>
                <div id="myAccountShipInfo" class="col-md-6">
...
?>
                <div id="myAccountPaymentInfo" class="col-md-6">
                    <div class="card h-100">
...
echo zen_draw_form('order_status', zen_href_link(FILENAME_ORDER_STATUS, 'action=status', $request_type), 'post', 'class="needs-validation" novalidate');
?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-sm-6">
                    <div class="form-floating mb-3">
                        <?= zen_draw_input_field('order_id', $orderID, 'size="10" id="order_id" placeholder="' . ENTRY_ORDER_NUMBER . '" class="form-control" required', 'number') ?> 
                        <label class="form-label" for="order_id"><?= ENTRY_ORDER_NUMBER ?><span class="text-danger">*</span></label>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-floating mb-3">
                        <?= zen_draw_input_field('query_email_address', $query_email_address, 'size="35" id="query_email_address" placeholder="' . ENTRY_EMAIL . '" class="form-control" required', 'email') ?>
                        <label class="form-label" for="query_email_address"><?= ENTRY_EMAIL ?><span class="text-danger">*</span></label>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end mt-3">
                <?= zen_image_submit(BUTTON_IMAGE_CONTINUE, BUTTON_CONTINUE_ALT, '', 'btn btn-primary') ?>
            </div>
        </div>
    </div>
<?= '</form>' ?>
