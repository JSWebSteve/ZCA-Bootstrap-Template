 ...
 */
?>
<div id="page3Default" class="centerColumn" role="main">
...
?>
    <div id="page3Default-btn-toolbar" class="d-flex justify-content-start my-3" role="toolbar" aria-label="<?php echo ARIA_LABEL_TOOLBAR; ?>">
