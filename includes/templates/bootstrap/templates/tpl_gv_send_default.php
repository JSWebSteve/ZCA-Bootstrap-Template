...
<div id="gvSendDefault" class="centerColumn">
    ...
    <div id="giftCertificateAccount-card" class="card mb-3">
        ...
        <div id="giftCertificateAccount-card-body" class="card-body p-3" aria-labelledby="giftCertificateAccount-card-header">
...
?>
            ...
            <div id="giftCertificateAccount-btn-toolbar" class="d-flex justify-content-end my-3" role="toolbar">
...
?>
    <div id="giftCertificateSent-card" class="card mb-3">
        ...
        <div id="giftCertificateSent-card-body" class="card-body p-3" aria-labelledby="giftCertificateSent-card-header">   
            <div id="giftCertificateSent-content" class="content"><?php echo TEXT_SUCCESS; ?></div>
            <div id="giftCertificateSent-btn-toolbar" class="d-flex justify-content-end my-3" role="toolbar">
...
?>
    <div id="giftCertificateConfirmation-card" class="card mb-3">
        ...
        <div id="giftCertificateConfirmation-card-body" class="card-body p-3" aria-labelledby="giftCertificateConfirmation-card-header"> 
...
?>
                ...
                <div id="giftCertificateConfirmation-btn-toolbar" class="d-flex justify-content-between" role="toolbar">
                    <?php echo zen_image_submit(BUTTON_IMAGE_EDIT_SMALL, BUTTON_EDIT_SMALL_ALT, 'name="edit" value="edit"', 'btn btn-secondary') .   zen_image_submit(BUTTON_IMAGE_CONFIRM_SEND, BUTTON_CONFIRM_SEND_ALT, '', 'btn btn-primary'); ?>
                </div>
            <?php echo '</form>'; ?>
        </div>
    </div>
...
?>
    <div id="sendGiftCertificate-card" class="card mb-3">
        ...
        <div id="sendGiftCertificate-card-body" class="card-body p-3" aria-labelledby="sendGiftCertificate-card-header">   
<?php
...
?>
            <?php echo zen_draw_form('gv_send_send', zen_href_link(FILENAME_GV_SEND, 'action=send', 'SSL', false)); ?>
                ...
                <div class="form-floating mb-3">
                    <?php echo zen_draw_input_field('to_name', $to_name, 'size="40" id="to-name" placeholder="' . ENTRY_FIRST_NAME_TEXT . '" class="form-control"' . ((int)ENTRY_FIRST_NAME_MIN_LENGTH > 0 ? ' required' : '')); ?>
                    <label class="form-label" for="to-name"><?php echo ENTRY_RECIPIENT_NAME; ?><?php echo ((int)ENTRY_FIRST_NAME_MIN_LENGTH > 0 ? '<span class="text-danger">*</span>' : ''); ?></label>
                </div>

                <div class="form-floating mb-3">
                    <?php echo zen_draw_input_field('email', (!empty($_POST['email'])? $_POST['email'] : ''), 'size="40" id="email-address" placeholder="' . ENTRY_EMAIL_ADDRESS_TEXT . '" class="form-control"' . ((int)ENTRY_EMAIL_ADDRESS_MIN_LENGTH > 0 ? ' required' : ''), 'email'); ?>
                    <label class="form-label" for="email-address"><?php echo ENTRY_EMAIL; ?><?php echo ((int)ENTRY_EMAIL_ADDRESS_MIN_LENGTH > 0 ? '<span class="text-danger">*</span>' : ''); ?></label>
                </div>

                <div class="form-floating mb-3">
                    <?php echo zen_draw_input_field('amount', (!empty($_POST['amount']) ? $_POST['amount'] : ''), 'id="amount" placeholder="' . ENTRY_AMOUNT_TEXT . '" class="form-control"' . ' required', 'text', false); ?>
                    <label class="form-label" for="amount"><?php echo ENTRY_AMOUNT; ?><span class="text-danger">*</span></label>
                </div>

                <div class="form-floating mb-3">
                    <?php echo zen_draw_textarea_field('message', '50', '10',  (!empty($_POST['message']) ? stripslashes($_POST['message']) : ''), 'id="message-area" placeholder="' . ENTRY_MESSAGE_TEXT . '" class="form-control"'); ?>
                    <label class="form-label" for="message-area"><?php echo ENTRY_MESSAGE; ?></label>
                </div>
                ...
                <div id="sendGiftCertificate-btn-toolbar3" class="d-flex justify-content-between" role="toolbar">
                    <?php echo zca_back_link() . zen_image_submit(BUTTON_IMAGE_SEND, BUTTON_SEND_ALT, '', 'btn btn-primary'); ?>
                </div>
            <?php echo '</form>'; ?>
        </div>  
    </div>
